<div class="p-6 lg:p-8 w-full max-w-7xl mx-auto font-['Inter'] space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <button class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0050cb] hover:bg-[#003fa4] text-white rounded-xl font-semibold text-[14px] transition-all shadow-md">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8 bg-gradient-to-br from-white to-[#f6f3f2] dark:from-slate-800 dark:to-slate-800/80 border border-[#c2c6d8]/50 dark:border-slate-700 rounded-3xl p-8 shadow-sm relative overflow-hidden group">
            ...
            <div class="absolute top-0 right-0 w-96 h-96 bg-[#0050cb]/5 dark:bg-indigo-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 group-hover:scale-110 transition-transform duration-1000"></div>
            ...
            <div class="relative flex flex-col md:flex-row items-center gap-10">
                ...
                <div class="relative w-48 h-48 shrink-0 flex items-center justify-center">
                    <svg class="w-full h-full -rotate-90" viewBox="0 0 100 100">
                        ...
                        <circle class="text-[#0050cb] dark:text-indigo-500" cx="50" cy="50" fill="none" r="44" stroke="currentColor" stroke-dasharray="276" stroke-dashoffset="16" stroke-width="8" stroke-linecap="round"></circle>
                    </svg>
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-4">
                        ...
                        <div class="flex items-center gap-3 bg-white dark:bg-slate-900/50 px-4 py-2.5 rounded-xl border border-[#c2c6d8]/30 dark:border-slate-700">
                            <span class="material-symbols-outlined text-[#0050cb] dark:text-indigo-400 text-[20px]">schedule</span>
                            <div class="text-left">
        ...
        <div class="lg:col-span-4 bg-white dark:bg-slate-800 border border-[#c2c6d8]/50 dark:border-slate-700 rounded-3xl p-8 shadow-sm flex flex-col justify-between">
            <div>
                <div class="flex items-center gap-2 mb-2">
                    <span class="material-symbols-outlined text-[#0050cb] dark:text-indigo-400">rss_feed</span>
                ...
                <div class="space-y-5">
                    <div class="flex gap-4 group cursor-pointer">
                        <div class="w-2.5 h-2.5 mt-1.5 rounded-full bg-[#0050cb] dark:bg-indigo-400 shrink-0 group-hover:scale-125 transition-transform"></div>
                        <div>
                            <p class="text-[15px] font-semibold text-[#1c1b1b] dark:text-white group-hover:text-[#0050cb] dark:group-hover:text-indigo-400 transition-colors">New TDS Circular v2.1</p>
                    ...
                    <div class="flex gap-4 group cursor-pointer">
                        ...
                        <div>
                            <p class="text-[15px] font-semibold text-[#1c1b1b] dark:text-white group-hover:text-[#0050cb] dark:group-hover:text-indigo-400 transition-colors">GST Portal Maintenance</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white dark:bg-slate-800 border border-[#ba1a1a]/20 dark:border-red-900/30 rounded-3xl p-8 shadow-sm hover:shadow-md hover:border-[#ba1a1a]/40 dark:hover:border-red-500/50 transition-all flex flex-col justify-between">
            ...
            <div class="mt-8 p-4 bg-[#f6f3f2] dark:bg-slate-900/80 rounded-xl border border-[#c2c6d8]/50 dark:border-slate-700">
                <div class="flex items-center gap-2 mb-2">
                    <span class="material-symbols-outlined text-[#0050cb] dark:text-indigo-400 text-[16px]">smart_toy</span>
                    <p class="text-[12px] font-['Geist'] font-bold text-[#0050cb] dark:text-indigo-400 uppercase tracking-wide">AI Recommendation</p>
                </div>
        ...
        <div class="bg-white dark:bg-slate-800 border border-[#0050cb]/20 dark:border-indigo-900/30 rounded-3xl p-8 shadow-sm hover:shadow-md hover:border-[#0050cb]/40 dark:hover:border-indigo-500/50 transition-all flex flex-col justify-between">
            <div>
                <div class="flex items-center justify-between mb-6">
                    <div class="w-12 h-12 rounded-xl bg-[#e1e0ff] dark:bg-indigo-900/40 flex items-center justify-center text-[#0050cb] dark:text-indigo-400">
                        <span class="material-symbols-outlined text-[24px]">psychology</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full bg-[#0050cb] dark:bg-indigo-400 animate-pulse"></span>
                        <span class="px-3 py-1 bg-[#e1e0ff]/50 dark:bg-indigo-900/20 text-[#0050cb] dark:text-indigo-400 rounded-full text-[12px] font-['Geist'] font-bold tracking-wide uppercase">
                            Active Scan
                        </span>
                    </div>
                </div>
            ...
            <button class="mt-8 w-full inline-flex justify-center items-center gap-2 px-5 py-3 bg-[#e1e0ff]/30 hover:bg-[#e1e0ff] dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 text-[#0050cb] dark:text-indigo-400 rounded-xl font-bold text-[14px] transition-colors">
    ...
    <div class="pt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Advisory 1 -->
            <div class="group bg-[#f6f3f2]/50 dark:bg-slate-800/50 border border-[#c2c6d8]/50 dark:border-slate-700 hover:border-[#0050cb] dark:hover:border-indigo-500 rounded-3xl p-8 transition-all cursor-pointer">
                <div class="flex items-center gap-4 mb-6">
                    <div class="w-14 h-14 bg-white dark:bg-slate-800 rounded-2xl shadow-sm flex items-center justify-center group-hover:bg-[#0050cb] dark:group-hover:bg-indigo-500 transition-colors">
                        <span class="material-symbols-outlined text-[#0050cb] dark:text-indigo-400 group-hover:text-white text-[28px]">account_balance</span>
                    </div>
                    <div>
                        <p class="text-[12px] font-['Geist'] font-bold text-[#0050cb] dark:text-indigo-400 uppercase tracking-wide mb-1">Upcoming Trigger</p>
