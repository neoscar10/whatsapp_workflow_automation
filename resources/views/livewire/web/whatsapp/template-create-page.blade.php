        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                ...
                <div class="bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 px-6 py-4 flex items-center justify-end gap-3">
                    <a href="{{ route('whatsapp.templates.index') }}" class="inline-flex items-center justify-center rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-300 shadow-sm hover:bg-slate-100 dark:hover:bg-slate-700 cursor-pointer transition-all">
                        Cancel
                    </a>

                    <button wire:click="createTemplate" wire:loading.attr="disabled" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl bg-primary hover:bg-[#1fbd5a] active:bg-[#1ea951] px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 cursor-pointer transition-all disabled:opacity-50 disabled:cursor-not-allowed">
