        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                ...
                <div class="bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 px-6 py-4 flex items-center justify-end gap-3">
                    ...
                    <button wire:click="createTemplate" wire:loading.attr="disabled" type="button" class="inline-flex items-center justify-center gap-2 rounded-xl bg-[#2463eb] hover:bg-[#1f57cf] active:bg-[#1b4cb8] px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-[#2463eb]/20 cursor-pointer transition-all disabled:opacity-50 disabled:cursor-not-allowed">
